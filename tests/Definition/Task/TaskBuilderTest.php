...
class TaskBuilderTest extends TestCase
{
    ...
    {
        return [[['id' => 1, 'value' => 1, 'operator' => EqualToTask::TASK_NAME, 'type' => 'type'], EqualToTask::class], [['id' => 1, 'value' => 1, 'operator' => LessThanTask::TASK_NAME, 'type' => 'type'], LessThanTask::class], [['id' => 1, 'value' => 1, 'operator' => MoreThanTask::TASK_NAME, 'type' => 'type'], MoreThanTask::class], [['operator' => OrTask::TASK_NAME, 'children' => [['id' => 1, 'value' => 1, 'operator' => EqualToTask::TASK_NAME, 'type' => 'type'], ['id' => 1, 'value' => 1, 'operator' => EqualToTask::TASK_NAME, 'type' => 'type']]], OrTask::class], [['operator' => AndTask::TASK_NAME, 'children' => [['id' => 1, 'value' => 1, 'operator' => EqualToTask::TASK_NAME, 'type' => 'type'], ['id' => 1, 'value' => 1, 'operator' => EqualToTask::TASK_NAME, 'type' => 'type']]], AndTask::class]];
    }
}
